...
frappe.query_reports["L&T Accounts Receivable"] = {
	"filters": [
		{
			"fieldname":"company",
			"label": __("Company"),
	...
	onload: function(report) {
		report.page.add_inner_button(__("Accounts Receivable Summary"), function() {
			...
			frappe.set_route('query-report', 'Accounts Receivable Summary', {company: filters.company, customer_group: filters.customer_group});
		});
	}
}
